...
⬡═—⊱ IPHONE BUG ⊰—═⬡
• /xcios → CRASH IOS SPAM
• /xiosone → CRASH IOS ONE MSSG

⬡═—⊱ ANDROID BUG ⊰—═⬡
• /xuiandro → BLANK DEVICE UI
• /xandro → BLANK DEVICE
• /xlogo → STUCK LOGO DEVICE  
...
${warnings.length ? "\n" + warnings.join("\n") : ""}
    ...
    return bot.sendMessage(
      chatId,
      `<pre>  ❌ ERROR MAMPUS, JASFIX DM @ApongSkt
